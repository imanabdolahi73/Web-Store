...
namespace WebStoreCore.Application.Services.Products.Queries.GetProductForAdmin
{
    ...
    public class GetProductForAdminService : IGetProductForAdminService
    {
        ...
        public ResultDto<ProductForAdminDto> Execute(int Page = 1, int PageSize = 100)
        {
            int rowCount = 0;
